   ...
   60 REM also expanded abbreviated INPUT, PRINT""
   70 REM Original code had leading zeros in line #
00090 PRINT "LIFE WITH TINY BASIC EXTENDED"
00100 PRINT "SIZE";
...
00300 PRINT "GENERATION ";E
00301 PRINT
00302 IF F > 0 GO TO 305
00303 PRINT "POPULATION IS ZERO"
  304 END
00305 PRINT "POPULATION IS ";F
00310 GO SUB 6000
00315 LET F=0
00320 GO SUB 5000
00330  E=E+1
  331 IF E<=D GOTO 291
00335 PRINT "HOW MANY MORE";
  336 INPUT C
  337 PRINT
00345 IF C = 0 END
00350 LET S=E
